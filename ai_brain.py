...
def analyze_message(user_text):
    ...
    prompt = f"""
أنت مساعد لبوت قرآن كريم على تليجرام.

رسالة المستخدم:
"{user_text}"

إذا كانت الرسالة طلباً لسورة أو آيات، أرجع JSON فقط بهذا الشكل:

{{"type": "quran", "surah_name": "البقرة", "surah_num": 2, "start": 1, "end": 5}}

إذا كانت الرسالة دردشة عادية، أرجع بهذا الشكل:

{{"type": "chat", "message": "رد قصير وطبيعي"}}

لا تكتب أي كلام خارج JSON.
لا تستخدم صيغة المؤنث أو المذكر، واستخدم صيغة محايدة.
"""
